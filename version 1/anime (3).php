...
if (!empty($week)) {
    $sql .= " AND DAYNAME(DateR) = '$week'";
                            ...
                            echo '<div class="anime-item">
                                    ...
                                    <div class="anime-info">
                                        ...
                                        <div class="anime-actions">
                                            ...
                                            <button class="delete-btn" onclick="deleteAnime('.$row['Rec_Num'].')">Delete</button> | <p style="font-size:15px;">Watch:</p> 
                                            <button class="lnk-btn1">Link 1</button>
                                            <button class="lnk-btn2">Link 2</button>
                                        </div>
                ...
                if(isset($_POST['Ebtn'])) {
                    ...
                    // Fixed query: Only show anime from current season that air today
                    $sql = "SELECT Rec_Num, Title, Year, Season, DateR, Img, Synopsis FROM main_db 
            ...
            <div id="add-section" class="card add-card hidden">
                ...
                <div class="upload-options">
                    <div class="file-upload-container">
                        ...
                        <span id="fileName">Select file or upload from clipboard</span>
                    </div>
                ...
                try {
                    ...
                    const saveResponse = await fetch('?action=db_connection&for=anime', {
                        ...
                        body: JSON.stringify({
                            ...
                            date: date,
                            synopsis: '' // Empty synopsis for new anime
                        })
                    });
