    ...
    <body class="anime-app">
        <div class="container">
            ...
            <header>
                ...
                <div class="season-display">Current Season: <?php echo $var; ?> <?php echo $Y; ?></div>
            </header>

            <div class="button-group">
                <button onclick="showTodayEpisodes()">Today's Episodes</button>
                <button onclick="showSearch()">Search Anime</button>
                <button onclick="showAddForm()">Add Anime</button>
            </div>

            <!-- Search Section -->
            <div id="search-section" class="add-show-form hidden">
                <h2>Search Anime</h2>
                <div class="form-grid">
                    <div class="form-group">
                        <label for="search-year">Year</label>
                        <input type="number" id="search-year" min="1900" max="<?php echo date('Y'); ?>" value="<?php echo $Y; ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="search-season">Season</label>
                        <select id="search-season">
                    ...
                    <div class="form-group">
                        <label for="search-week">Week Day</label>
                        <select id="search-week">
            ...
            <!-- Add Anime Section -->
            <div id="add-section" class="add-show-form hidden">
                <h2>Add New Anime</h2>
                <div class="form-grid">
                    <div class="form-group">
                        <label for="anime-title">Title</label>
                        <input type="text" id="anime-title" required placeholder="Anime title">
                    </div>
                    
                    <div class="form-group">
                        <label for="anime-date">Release Date</label>
                        <input type="date" id="anime-date" value="<?php echo date('Y-m-d'); ?>" onchange="updateSeason()">
                    </div>
                    
                    <div class="form-group">
                        <label for="anime-season">Season</label>
                        <select id="anime-season">
                            <option value="Summer">Summer</option>
                            <option value="Fall">Fall</option>
                            <option value="Winter">Winter</option>
                            <option value="Spring">Spring</option>
                    ...
                    <div class="form-group">
                        <label>&nbsp;</label>
                        <button onclick="uploadImage(event)">Add Anime</button>
                    </div>
                </div>

                <div class="watchlist-checkbox">
                    <input type="checkbox" id="add-to-watchlist">
                    <label for="add-to-watchlist">Also add to show tracker</label>
                </div>
            ...
            <div id="results-section">
                <div class="search-result" id="anime-results">
                    <?php
                    // Display initial results if any
                    if(isset($_POST['Sbtn']) || isset($_POST['Ebtn']) || isset($_POST['Abtn'])) {
                        include 'anime_results.php';
                    }
                    ?>
                </div>
            </div>
        ...
        <script>
            ...
            function showTodayEpisodes() {
                hideAllSections();
                // This would typically make an AJAX call to load today's episodes
                alert("Today's episodes functionality would load here");
            }
            ...
            function updateSeason() {
                const dateInput = new Date(document.getElementById('anime-date').value);
                const monthHolder = dateInput.getMonth();

                if (monthHolder >= 2 && monthHolder <= 4) {
                    document.getElementById('anime-season').value = 'Spring';
                } else if (monthHolder >= 5 && monthHolder <= 7) {
                    document.getElementById('anime-season').value = 'Summer';
                } else if (monthHolder >= 8 && monthHolder <= 10) {
                    document.getElementById('anime-season').value = 'Fall';
                } else {
                    document.getElementById('anime-season').value = 'Winter';
                }
            }
            ...
            function searchAnime() {
                ...
                const week = document.getElementById('search-week').value;
                
                // This would typically make an AJAX call to search anime
                alert(`Searching for: ${season} ${year}, Day: ${week || 'Any'}`);
            }
            ...
            async function uploadImage(event) {
                ...
                try {
                    ...
                    const addToWatchlist = document.getElementById('add-to-watchlist').checked;
                    ...
                    if (!imageBlob && lastPastedImage) {
                        imageBlob = lastPastedImage;
                    }
                    ...
                    showStatus(`${title} added successfully!`, 'success');
                                ...
                                <div class="edit-form">
                                    ...
                                    <div class="form-grid">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="edit-title" value="${data.anime.Title}">
                                        </div>
                                        <div class="form-group">
                                            <label for="edit-year">Year</label>
                                            <input type="number" id="edit-year" value="${data.anime.Year}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="edit-date" value="${data.anime.DateR}">
                                        </div>
                                    </div>
            ...
            document.addEventListener('paste', (event) => {
                ...
                for (let i = 0; i < items.length; i++) {
                    if (items[i].type.indexOf('image') !== -1) {
                        lastPastedImage = items[i].getAsFile();
                        document.getElementById('fileName').textContent = 'Image from clipboard';
                        document.getElementById('fileError').style.display = 'none';
                        break;
                    }
                }
